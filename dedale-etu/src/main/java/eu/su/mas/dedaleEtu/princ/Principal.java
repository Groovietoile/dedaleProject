...
//		
//		//4) Give the class name of your agent to let the system instantiate it
//		ag=createNewDedaleAgent(c, agentName, DummyMovingAgent.class.getName(), entityParametersGolem1);
//		agentList.add(ag);
////		
//////		/*********
//////		 * GOLEM 2
...
//		
//		//4) Give the class name of your agent to let the system instantiate it
//		ag=createNewDedaleAgent(c, agentName, DummyMovingAgent.class.getName(), entityParametersGolem2);
//		agentList.add(ag);
//		
////		/*********
////		 * GOLEM 3
...
//		
//		//3) If you want to give specific parameters to your agent, add them here
//		Object [] entityParametersGolem3={"My parameters"};
//		
//		//4) Give the class name of your agent to let the system instantiate it
//		ag=createNewDedaleAgent(c, agentName, DummyMovingAgent.class.getName(), entityParametersGolem3);
//		agentList.add(ag);
//		
//	
//		
...
//		
//		//4) Give the class name of your agent to let the system instantiate it
//		ag=createNewDedaleAgent(c, agentName, HunterAgent.class.getName(), entityParametersExplo4);//ExploreSoloAgent
//
//		agentList.add(ag);
//		
//		/*********
...
//		
//		//4) Give the class name of your agent to let the system instantiate it
//		ag=createNewDedaleAgent(c, agentName, HunterAgent.class.getName(), entityParametersExplo5);//ExploreSoloAgent
//
//		agentList.add(ag);
//		
//		/*********
...
//		
//		//3) If you want to give specific parameters to your agent, add them here
//		Object [] entityParametersExplo6={"My parameters"};
//		
//		//4) Give the class name of your agent to let the system instantiate it
//		ag=createNewDedaleAgent(c, agentName, HunterAgent.class.getName(), entityParametersExplo6);//ExploreSoloAgent
//
//		agentList.add(ag);
//		
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersGolem={"My parameters"};
		
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, DummyWumpusShift.class.getName(), entityParametersGolem);
		agentList.add(ag);	
